...
| `MAX_SESSIONS`         | Soft cap — oldest session evicted when exceeded | `20`                        |
...
Session settings are also configurable via the dashboard Settings page (overrides env var defaults).
