  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center">
      <div className="text-center">
        ...
        <p className="text-dark-400 mb-8">{t("auth.login.description")}</p>

        <button
          onClick={handleGoogleLogin}
          className="group flex items-center gap-3 px-6 py-3 bg-white hover:bg-gray-50 text-gray-800 font-medium rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl mx-auto"
        >
